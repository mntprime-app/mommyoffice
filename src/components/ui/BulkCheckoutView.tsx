          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
            <div style={{ background: '#fff', borderRadius: '20px', padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px', boxShadow: '0 8px 40px rgba(0,181,173,0.2)', maxWidth: '100%' }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <p style={{ fontSize: '14px', fontWeight: 700, color: '#222', margin: '0 0 3px' }}>₮{total.toLocaleString()} төлнө үү</p>
                <p style={{ fontSize: '11px', color: '#888', margin: 0 }}>{courses.length} сургалт · QPay апп → QR скан хийнэ үү</p>
              </div>
            </div>
          </div>
